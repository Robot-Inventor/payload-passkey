...
const ta = {
    passkeyPlugin: {
        ...
        managementClient: {
            ...
            confirmDelete: {
                heading: "நீக்கலை உறுதிசெய்",
                body: "பாஸ்கீ {{name}}-ஐ நீக்கவிருக்கிறீர்கள். உறுதியாகவா?"
            },
        ...
        managementField: {
            ...
            reauthenticationRequired: "உங்கள் பாதுகாப்பிற்காக பாஸ்கீகளை நிர்வகிக்க மீண்டும் உள்நுழையவும்.",
