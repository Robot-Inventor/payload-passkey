...
const bnIn = {
    passkeyPlugin: {
        loginButton: {
            or: "বা",
            failedToLogin: "পাসকি দিয়ে লগইন করা যায়নি।",
            notAllowed: "পাসকির কার্যক্রম বাতিল করা হয়েছে বা অনুমোদিত নয়।",
            loginWithPasskey: "পাসকি দিয়ে লগইন করুন"
        },
        managementClient: {
            ...
            confirmDelete: {
                heading: "মুছে ফেলা নিশ্চিত করুন",
                body: "আপনি পাসকি {{name}} মুছতে চলেছেন। আপনি কি নিশ্চিত?"
            },
        ...
        managementField: {
            ...
            reauthenticationRequired: "আপনার নিরাপত্তার জন্য পাসকি পরিচালনা করতে আবার লগইন করুন।",
